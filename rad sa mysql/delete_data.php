...
// 2. PERFORM DATABASE QUERY
	...
	$query = "DELETE subjects WHERE id = {$id} LIMIT 1";
					OR
	$query  = "DELETE from subjects "; 
	$query .= "WHERE id = {$id} ";
	$query .= "LIMIT 1"; // limit the results that we affect. It is most usefull we we working with delete.It is just a sanity check to make sure that we only delete one.

	//echo $query -> for cheching SQL syntax 
